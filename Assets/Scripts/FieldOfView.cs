...
{
    public float viewRadius;    // Radius of the player
    [Range(0, 360)]
    public float viewAngle;     // Size of field of vision of the player
    ...
    void FindVisibleTargets()
    {
        /*
           Clears the list each time
                - the player's field of vision spots a new target
                - a target exits the player's field of vision
        */
